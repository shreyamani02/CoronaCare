//
//  homeNeedHelpViewController.swift
//  CoronaCare
//
...
class homeNeedHelpViewController: UIViewController {
    
    @IBOutlet weak var listings: UIButton!
    ...
    func setUpElements(){
        Utilities.styleFilledButton(listings)
